...
docker run --rm \
  ...
  bash -lc '
    ...
    mv /app/mooreCube/bin/codex/moore_codex /app/mooreCube/bin/codex/moore_codex_old && \

    # Install into the Moore platform tree
    cp target/release/codex /app/mooreCube/bin/codex/moore_codex && \
    chmod +x /app/mooreCube/bin/codex/moore_codex
  '

echo "Built codex and installed it to ${PLATFORM_DIR}/mooreCube/bin/codex/moore_codex"
